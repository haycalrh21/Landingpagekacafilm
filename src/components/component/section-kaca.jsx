							...
							<div className='flex flex-col justify-center space-y-4'>
								<div className='space-y-2'>
									...
									<p className='max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400'>
										Kaca film tidak hanya melindungi rumahmu dari sinar UV, tapi
										juga meningkatkan efisiensi energi dan memberikan privasi.
									</p>
								</div>
								<ul className='grid gap-4'>
									<li className='flex items-start gap-2'>
										...
										<div>
											<h3 className='text-lg font-semibold'>Perlindungan UV</h3>
									...
									<li className='flex items-start gap-2'>
										...
										<div>
											...
											<p className='text-gray-500 dark:text-gray-400'>
												Kaca film membantu menjaga suhu ruangan tetap nyaman dan
									...
									<li className='flex items-start gap-2'>
										...
										<div>
											...
											<p className='text-gray-500 dark:text-gray-400'>
												Kaca film memberikan privasi dan keamanan bagi rumahmu.
											</p>
										</div>
									</li>
								</ul>
							...
							<div className='grid sm:grid-cols-2 md:grid-cols-3 gap-8'>
								<div className='relative group'>
									...
									<div className='flex-1 py-4'>
										...
										<h4 className='font-semibold text-blue-500'>Rp 150.000</h4>
									</div>
								</div>
								<div className='relative group'>
									<Link className='absolute inset-0 z-10' href='#'>
									...
									<div className='flex-1 py-4'>
										...
										<h4 className='font-semibold text-blue-500'>Rp 200.000</h4>
									</div>
								</div>
								<div className='relative group'>
									<Link className='absolute inset-0 z-10' href='#'>
									...
									<div className='flex-1 py-4'>
										...
										<h4 className='font-semibold text-blue-500'>Rp 100.000</h4>
									</div>
								</div>
							</div>
						</div>
